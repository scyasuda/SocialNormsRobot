...
class Gesture:
    ...
    def connectNao(self):
        ...
        self.speechDevice.setVolume(1.8)
    ...
    def demo(self):
        ...
        self.genSpeech("Let me show you how I play")
        time.sleep(1)
    ...
    def announce(self, what):
        if(what is "win"): # NAO WON
            ...
            time.sleep(1)
        elif(what is "insult"): #INSULT
            print("in insult")
            randnr = random.randint(0,len(self.insult)-1)
            self.genSpeech(self.insult[randnr])
            time.sleep(1)
        elif(what is "yawn"): #YAWN
            print("in yawn")
            randnr = random.randint(0,len(self.yawn)-1)
